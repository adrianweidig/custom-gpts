# Entscheidungsvorlagen Builder - Example (Turkish)
...
Örnek açılış: `Entscheidungsvorlagen Builder` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
