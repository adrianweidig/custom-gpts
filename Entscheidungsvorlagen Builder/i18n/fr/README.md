# Entscheidungsvorlagen Builder - pack linguistique français
...
Ce dossier contient les composants produit en français pour `Entscheidungsvorlagen Builder`. L'allemand reste la langue source canonique; ce pack fournit un point d'entrée direct en français tout en préservant les identifiants techniques, noms de fichiers, paramètres de modèle et formats d'import.
