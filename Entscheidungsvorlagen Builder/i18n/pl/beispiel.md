# Entscheidungsvorlagen Builder - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `Entscheidungsvorlagen Builder`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
