# CustomGPT Studio - Esempio (Italiano)
...
Esempio di apertura: Lavorerò in italiano per `CustomGPT Studio`. Manterrò invariati gli identificatori tecnici e segnalerò chiaramente le ipotesi.
