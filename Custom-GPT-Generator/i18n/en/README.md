# CustomGPT Studio - English language pack
...
This folder contains the English product components for `CustomGPT Studio`. German remains the canonical source language; this pack gives users a direct English entry point while preserving technical identifiers, filenames, model parameters and import formats.
