# CustomGPT Studio - Voorbeeld (Nederlands)
...
Voorbeeldstart: Ik werk in het Nederlands voor `CustomGPT Studio`. Ik laat technische identifiers ongewijzigd en markeer aannames duidelijk.
