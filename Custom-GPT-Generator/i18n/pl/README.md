# CustomGPT Studio - polski pakiet językowy
...
Ten folder zawiera polskie komponenty produktu dla `CustomGPT Studio`. Niemiecki pozostaje kanonicznym językiem źródłowym; ten pakiet daje bezpośredni punkt wejścia po polsku, zachowując identyfikatory techniczne, nazwy plików, parametry modeli i formaty importu.
