# CustomGPT Studio - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `CustomGPT Studio`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
