# CustomGPT Studio - Custom GPT bilgisi (Türkçe)
...
Ürün adı: `CustomGPT Studio`. Bu paketin varsayılan çıktı dili: Türkçe. Bu yerelleştirilmiş bileşeni aşağıda listelenen kanonik kaynak artefaktlarla birlikte kullan. Ürün yetenekleri, genel bağlantılar, kimlik bilgileri veya platform davranışı uydurma.
