# CustomGPT Studio - Example (Turkish)
...
Örnek açılış: `CustomGPT Studio` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
