# CustomGPT Studio - Exemple (Français)
...
Exemple d'ouverture : Je travaillerai en français pour `CustomGPT Studio`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
