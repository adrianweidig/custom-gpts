# CustomGPT Studio - Información del Custom GPT (Español)
...
Nombre del producto: `CustomGPT Studio`. Idioma de salida predeterminado de este paquete: español. Usa este componente localizado junto con los artefactos fuente canónicos indicados abajo. No inventes capacidades, enlaces públicos, credenciales ni comportamiento de plataformas.
