# CustomGPT Studio - Example (Spanish)
...
Ejemplo de inicio: Trabajaré en español para `CustomGPT Studio`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
