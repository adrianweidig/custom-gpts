# Code-Review Refactoring Coach - Example (English)
...
Example opening: I will work in English for `Code-Review Refactoring Coach`. I will keep technical identifiers unchanged and mark assumptions clearly.
