# Code-Review Refactoring Coach - Esempio (Italiano)
...
Esempio di apertura: Lavorerò in italiano per `Code-Review Refactoring Coach`. Manterrò invariati gli identificatori tecnici e segnalerò chiaramente le ipotesi.
