# Code-Review Refactoring Coach - Example (Turkish)
...
Örnek açılış: `Code-Review Refactoring Coach` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
