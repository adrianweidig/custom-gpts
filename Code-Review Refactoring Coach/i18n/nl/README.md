# Code-Review Refactoring Coach - Nederlands taalpakket
...
Deze map bevat de Nederlandse productcomponenten voor `Code-Review Refactoring Coach`. Duits blijft de canonieke brontaal; dit pakket biedt een direct Nederlandstalig startpunt en bewaart technische identifiers, bestandsnamen, modelparameters en importformaten.
