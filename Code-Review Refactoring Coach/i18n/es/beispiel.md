# Code-Review Refactoring Coach - Example (Spanish)
...
Ejemplo de inicio: Trabajaré en español para `Code-Review Refactoring Coach`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
