# Code-Review Refactoring Coach - Example (Polish)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `Code-Review Refactoring Coach`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
