# Code-Review Refactoring Coach - polski pakiet językowy
...
Ten folder zawiera polskie komponenty produktu dla `Code-Review Refactoring Coach`. Niemiecki pozostaje kanonicznym językiem źródłowym; ten pakiet daje bezpośredni punkt wejścia po polsku, zachowując identyfikatory techniczne, nazwy plików, parametry modeli i formaty importu.
