# n8n Workflow Architect - English language pack
...
This folder contains the English product components for `n8n Workflow Architect`. German remains the canonical source language; this pack gives users a direct English entry point while preserving technical identifiers, filenames, model parameters and import formats.
