# n8n Workflow Architect - Example (Spanish)
...
Ejemplo de inicio: Trabajaré en español para `n8n Workflow Architect`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
