# n8n Workflow Architect - paquete de idioma español
...
Esta carpeta contiene los componentes de producto en español para `n8n Workflow Architect`. El alemán sigue siendo el idioma fuente canónico; este paquete ofrece una entrada directa en español sin cambiar identificadores técnicos, nombres de archivo, parámetros de modelo ni formatos de importación.
