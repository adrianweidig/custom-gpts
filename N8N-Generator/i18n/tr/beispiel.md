# n8n Workflow Architect - Example (Turkish)
...
Örnek açılış: `n8n Workflow Architect` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
