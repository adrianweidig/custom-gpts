# Testfall-Generator - Example (English)
...
Example opening: I will work in English for `Testfall-Generator`. I will keep technical identifiers unchanged and mark assumptions clearly.
