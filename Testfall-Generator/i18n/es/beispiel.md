# Testfall-Generator - Example (Spanish)
...
Ejemplo de inicio: Trabajaré en español para `Testfall-Generator`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
