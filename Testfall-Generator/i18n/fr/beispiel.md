# Testfall-Generator - Exemple (Français)
...
Exemple d'ouverture : Je travaillerai en français pour `Testfall-Generator`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
