# Testfall-Generator - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `Testfall-Generator`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
