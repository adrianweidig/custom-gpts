# Testfall-Generator - Türkçe dil paketi
...
Bu klasör `Testfall-Generator` için Türkçe ürün bileşenlerini içerir. Almanca kanonik kaynak dili olmaya devam eder; bu paket teknik tanımlayıcıları, dosya adlarını, model parametrelerini ve içe aktarma biçimlerini koruyarak doğrudan Türkçe bir giriş noktası sağlar.
