# Testfall-Generator - Example (Turkish)
...
Örnek açılış: `Testfall-Generator` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
