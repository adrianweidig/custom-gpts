# Testfall-Generator - Voorbeeld (Nederlands)
...
Voorbeeldstart: Ik werk in het Nederlands voor `Testfall-Generator`. Ik laat technische identifiers ongewijzigd en markeer aannames duidelijk.
