# Unterrichtsfolien & Handout Builder - Informacje Custom GPT (Polski)
...
Nazwa produktu: `Unterrichtsfolien & Handout Builder`. Domyślny język odpowiedzi w tym pakiecie: polski. Używaj tego zlokalizowanego komponentu razem z kanonicznymi artefaktami źródłowymi wymienionymi poniżej. Nie wymyślaj funkcji produktu, publicznych linków, poświadczeń ani zachowań platform.
