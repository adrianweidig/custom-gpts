# Unterrichtsfolien & Handout Builder - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `Unterrichtsfolien & Handout Builder`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
