# Unterrichtsfolien & Handout Builder - Örnek (Türkçe)
...
Örnek açılış: `Unterrichtsfolien & Handout Builder` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
