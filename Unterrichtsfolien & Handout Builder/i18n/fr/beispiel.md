# Unterrichtsfolien & Handout Builder - Exemple (Français)
...
Exemple d'ouverture : Je travaillerai en français pour `Unterrichtsfolien & Handout Builder`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
