# OpenWebUI Model Builder - Example (Turkish)
...
Örnek açılış: `OpenWebUI Model Builder` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
