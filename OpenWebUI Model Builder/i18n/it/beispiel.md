# OpenWebUI Model Builder - Esempio (Italiano)
...
Esempio di apertura: Lavorerò in italiano per `OpenWebUI Model Builder`. Manterrò invariati gli identificatori tecnici e segnalerò chiaramente le ipotesi.
