# OpenWebUI Model Builder - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `OpenWebUI Model Builder`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
