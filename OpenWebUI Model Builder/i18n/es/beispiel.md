# OpenWebUI Model Builder - Example (Spanish)
...
Ejemplo de inicio: Trabajaré en español para `OpenWebUI Model Builder`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
