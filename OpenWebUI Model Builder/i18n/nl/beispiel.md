# OpenWebUI Model Builder - Voorbeeld (Nederlands)
...
Voorbeeldstart: Ik werk in het Nederlands voor `OpenWebUI Model Builder`. Ik laat technische identifiers ongewijzigd en markeer aannames duidelijk.
