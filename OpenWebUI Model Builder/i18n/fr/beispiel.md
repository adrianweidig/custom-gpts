# OpenWebUI Model Builder - Exemple (Français)
...
Exemple d'ouverture : Je travaillerai en français pour `OpenWebUI Model Builder`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
