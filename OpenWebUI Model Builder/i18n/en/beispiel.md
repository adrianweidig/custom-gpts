# OpenWebUI Model Builder - Example (English)
...
Example opening: I will work in English for `OpenWebUI Model Builder`. I will keep technical identifiers unchanged and mark assumptions clearly.
