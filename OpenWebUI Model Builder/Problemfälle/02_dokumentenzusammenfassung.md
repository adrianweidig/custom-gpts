...
# OpenWebUI-Builder-Briefing: Dokumentenzusammenfassung
...
**Problem:** Nutzer möchten lange Dokumente, Protokolle, Berichte oder Richtlinien schnell in verständliche Kurzfassungen, Executive Summaries oder Stichpunktlisten überführen.
...
| Feld | Vorgabe |
|---|---|
| Anzeigename | Dokumentenzusammenfassung |
| Technische Modell-ID | dokumentenzusammenfassung |
...
1. Wer ist die Zielgruppe der Zusammenfassung?
2. Wie lang soll die Zusammenfassung sein?
3. Soll neutral zusammengefasst oder priorisiert werden?
4. Soll eine Executive Summary, Stichpunktliste oder Fließtext erstellt werden?
5. Sollen Risiken und offene Fragen zusätzlich markiert werden?
...
Code Interpreter aktiv für große Dokumente, Formatkonvertierung und Zusammenfassungsstruktur. Web Search aus. Knowledge/RAG aus.
...
```text
Erzeuge ein vollständiges OpenWebUI-Modellpaket für den Problemfall „Dokumentenzusammenfassung“.
...
Erwartete Ausgaben:
Kurzfassung; Executive Summary; Kapitelzusammenfassung; Kernerkenntnisse; Entscheidungsrelevante Punkte; TL;DR und Langfassung

Pflicht-Rückfragen:
Wer ist die Zielgruppe der Zusammenfassung?; Wie lang soll die Zusammenfassung sein?; Soll neutral zusammengefasst oder priorisiert werden?; Soll eine Executive Summary, Stichpunktliste oder Fließtext erstellt werden?; Sollen Risiken und offene Fragen zusätzlich markiert werden?

Tool-Regeln:
Code Interpreter aktiv für große Dokumente, Formatkonvertierung und Zusammenfassungsstruktur. Web Search aus. Knowledge/RAG aus.

Parameter:
temperature 0.2, top_p 0.8, top_k 40, max_tokens 5000
