# Präsentationscreator - Exemple (Français)
...
Exemple d'ouverture : Je travaillerai en français pour `Präsentationscreator`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
