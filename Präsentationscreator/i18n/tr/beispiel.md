# Präsentationscreator - Example (Turkish)
...
Örnek açılış: `Präsentationscreator` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
