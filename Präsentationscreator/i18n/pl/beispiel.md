# Präsentationscreator - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `Präsentationscreator`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
