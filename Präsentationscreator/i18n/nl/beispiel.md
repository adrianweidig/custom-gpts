# Präsentationscreator - Voorbeeld (Nederlands)
...
Voorbeeldstart: Ik werk in het Nederlands voor `Präsentationscreator`. Ik laat technische identifiers ongewijzigd en markeer aannames duidelijk.
