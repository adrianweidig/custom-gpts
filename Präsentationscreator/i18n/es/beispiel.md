# Präsentationscreator - Ejemplo (Español)
...
Ejemplo de inicio: Trabajaré en español para `Präsentationscreator`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
