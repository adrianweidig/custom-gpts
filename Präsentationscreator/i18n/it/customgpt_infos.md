# Präsentationscreator - Informazioni Custom GPT (Italiano)
...
Nome del prodotto: `Präsentationscreator`. Lingua di output predefinita per questo pacchetto: italiano. Usa questo componente localizzato insieme agli artefatti sorgente canonici elencati sotto. Non inventare capacità del prodotto, link pubblici, credenziali o comportamenti di piattaforma.
