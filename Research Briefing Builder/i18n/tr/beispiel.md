# Research Briefing Builder - Example (Turkish)
...
Örnek açılış: `Research Briefing Builder` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
