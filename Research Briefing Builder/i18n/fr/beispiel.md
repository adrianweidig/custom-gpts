# Research Briefing Builder - Exemple (Français)
...
Exemple d'ouverture : Je travaillerai en français pour `Research Briefing Builder`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
