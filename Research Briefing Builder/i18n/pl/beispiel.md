# Research Briefing Builder - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `Research Briefing Builder`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
