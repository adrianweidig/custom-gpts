# KI-Integration Sicherheitsberater - Example (English)
...
Example opening: I will work in English for `KI-Integration Sicherheitsberater`. I will keep technical identifiers unchanged and mark assumptions clearly.
