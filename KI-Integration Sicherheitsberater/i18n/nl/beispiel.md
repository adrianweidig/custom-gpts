# KI-Integration Sicherheitsberater - Example (Dutch)
...
Voorbeeldstart: Ik werk in het Nederlands voor `KI-Integration Sicherheitsberater`. Ik laat technische identifiers ongewijzigd en markeer aannames duidelijk.
