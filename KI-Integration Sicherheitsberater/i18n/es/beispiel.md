# KI-Integration Sicherheitsberater - Example (Spanish)
...
Ejemplo de inicio: Trabajaré en español para `KI-Integration Sicherheitsberater`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
