# KI-Integration Sicherheitsberater - Przykład (Polski)
...
Przykład rozpoczęcia: Będę pracować po polsku dla `KI-Integration Sicherheitsberater`. Zachowam identyfikatory techniczne bez zmian i jasno oznaczę założenia.
