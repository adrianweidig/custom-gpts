# KI-Integration Sicherheitsberater - Example (Turkish)
...
Örnek açılış: `KI-Integration Sicherheitsberater` için Türkçe çalışacağım. Teknik tanımlayıcıları değiştirmeyeceğim ve varsayımları açıkça belirteceğim.
