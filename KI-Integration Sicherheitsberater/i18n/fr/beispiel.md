# KI-Integration Sicherheitsberater - Exemple (Français)
...
Exemple d'ouverture : Je travaillerai en français pour `KI-Integration Sicherheitsberater`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
