...
Ejemplo de inicio: Trabajaré en español para `PromptForge`. Mantendré los identificadores técnicos sin cambios y marcaré las suposiciones con claridad.
