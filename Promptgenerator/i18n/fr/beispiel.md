...
Exemple d'ouverture : Je travaillerai en français pour `PromptForge`. Je conserverai les identifiants techniques inchangés et signalerai clairement les hypothèses.
