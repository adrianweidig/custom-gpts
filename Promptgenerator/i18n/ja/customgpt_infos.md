# PromptForge - Custom GPT Info (Japanese)
...
プロダクト名: `PromptForge`。このパックの既定出力言語: 日本語。このローカライズ済みコンポーネントを、下記の正規ソース成果物と一緒に使用してください。プロダクト機能、公開リンク、認証情報、プラットフォーム動作を作り上げてはいけません。
