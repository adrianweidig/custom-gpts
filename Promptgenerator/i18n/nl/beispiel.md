# PromptForge - Voorbeeld (Nederlands)
...
Voorbeeldstart: Ik werk in het Nederlands voor `PromptForge`. Ik laat technische identifiers ongewijzigd en markeer aannames duidelijk.
