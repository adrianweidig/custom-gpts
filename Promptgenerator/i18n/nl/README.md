# PromptForge - Nederlands taalpakket
...
Deze map bevat de Nederlandse productcomponenten voor `PromptForge`. Duits blijft de canonieke brontaal; dit pakket biedt een direct Nederlandstalig startpunt en bewaart technische identifiers, bestandsnamen, modelparameters en importformaten.
